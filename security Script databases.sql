...
,	SQL2012_ABOVE_CREATETSQL = 'ALTER  ROLE [' + r.name COLLATE DATABASE_DEFAULT + '] ADD MEMBER [' + d.name COLLATE DATABASE_DEFAULT + ']'
,	SQL2012_ABOVE_DROPTSQL = 'ALTER  ROLE [' + r.name COLLATE DATABASE_DEFAULT + '] DROP MEMBER [' + d.name COLLATE DATABASE_DEFAULT + ']'
