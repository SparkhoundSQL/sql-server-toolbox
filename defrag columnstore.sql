...
,	Size_GB = gps.size_in_bytes/1024./1024.
...
--then Reorganize potentially even a third time to remove any remaining TOMBSTONE rowgroups'
...
GROUP BY o.name, gps.state_desc, gps.object_id, o.schema_id, i.name, gps.size_in_bytes
