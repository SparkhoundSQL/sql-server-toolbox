...
/****** Object:  StoredProcedure [dbo].[BackupFailureNotification]    Script Date: 4/19/2019 9:47:19 AM ******/
SET ANSI_NULLS ON
GO
...
--IF (SELECT count(*) FROM #BackupFailure) > 0
--BEGIN
--    INSERT INTO dbo.BackupFailure (database_name 
--	, backuptype 
--	, recovery_model_desc
--	, LatestBackupDate 
