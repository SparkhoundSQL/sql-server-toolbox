...
GO
BACKUP DATABASE [dbaadmin] TO  URL = N'https://sphsqlbackup.blob.core.windows.net/prodsqlbak/dbaadmin_backup_2017_10_24.bak' 
WITH  NAME = N'dbaadmin-Full Database Backup', NOREWIND, NOUNLOAD, COMPRESSION,  STATS = 10, CHECKSUM
GO
*/
...
BACKUP DATABASE [dbaadmin] TO  URL = N'https://sphsqlbackup.blob.core.windows.net/prodsqlbak/test/dbaadmin_backup_2017_10_24_151352.bak' 
WITH CREDENTIAL = 'https://sphsqlbackup.blob.core.windows.net/prodsqlbak',
FORMAT, NAME = N'dbaadmin-Full Database Backup', NOREWIND, NOUNLOAD, COMPRESSION,  STATS = 10, CHECKSUM
GO
